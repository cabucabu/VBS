...
Set AFileStream = FSO1.CreateTextFile("c:\CFMS\UnAcknowledge\" & Arrval(4) & ".txt",true) '2 for writing 8 to append
'	AFileStream.WriteLine "SYSTEM:"& Arrval(0) & " DBPTR:"  & Arrval(1) & " USER:" & Arrval(2) & " ID:" & Arrval(3) & " ANAME:" & Arrval(4) & " DATE:" & Arrval(5) & " TIME:" & Arrval(6) & " MANAGER:" & Arrval(7) & " Site:" & Arrval(13) & " SERV:" & Arrval(9) & " AMO:" & Arrval(10)  & " DESC:" & Arrval(11) & " Site:" & Arrval(12) & " Class:" & Arrval(8)
	AFileStream.WriteLine "<TTS_ID>Unack(Activity)</TTS_ID>"
...
'strCommandLine = "c:\CFMS\ClientSendFile\ClientSendFile.exe 10.216.148.205 9222 c:\CFMS\UnAcknowledge\" & Arrval(4) & ".txt"
...
Set SendFile_Msg = SendFile.CreateTextFile("c:\CFMS\UnAcknowledge\" & Arrval(4) & ".bat",true) 
	SendFile_Msg.WriteLine "ClientSendFile.exe 10.216.148.205 9222 " & Arrval(4) & ".txt"
	SendFile_Msg.close

set SendFile_Msg = nothing
objShell.run "cmd /C CD c:\CFMS\UnAcknowledge\ & " & Arrval(4) & ".bat",0,true
WScript.Sleep 2000
strCommandLine = "c:\CFMS\UnAcknowledge\del.bat " & Arrval(4) & ".bat"
...
For k=1 To 30000000
Next
strCommandLine = "C:\CFMS\UnAcknowledge\del.bat " & Arrval(4) & ".txt"
objShell.Run(strCommandLine),0,true
