...
'	AFileStream.WriteLine oArgs(0)
	AFileStream.WriteLine "<CF>"
	AFileStream.WriteLine "<IP>" & ip & "</IP>"
	AFileStream.WriteLine "<USER>" & Arrval(2) & "</USER>"
	AFileStream.WriteLine "<EVENT_DATE_TIME>" & DateToStr() & " " & time &  "</EVENT_DATE_TIME>"
...
'strCommandLine = "c:\CFMS\ClientSendFile\ClientSendFile.exe 197.8.9.233 1500 c:\CFMS\TTS\" & Arrval(3) & ".txt"
'strCommandLine = "C:\CFMS\ClientSendFile\ClientSendFile.exe 10.208.152.12 1500 C:\CFMS\TTS\" & Arrval(3) & ".txt"
'strCommandLine = "cmd /K type c:\Documents and Settings\All Users\Documents\ClientSendFile\ClientSendFile.exe 10.208.152.12 1500 c:\CFMS\TTS\" & Arrval(3) & ".txt"
'strCommandLine = 
objShell.Run """C:\Documents and Settings\All Users\Documents\My Videos\ClientSendFile\ClientSendFile.exe""" & " 10.208.152.12 1500 c:\CFMS\TTS\" & Arrval(3) & ".txt"
